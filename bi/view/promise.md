...
## [#](#_4-promise中的all和race) 4. Promise中的all和race
...
## [#](#_5-async-await的几道题) 5. async/await的几道题
...
### [#](#_8-1-使用promise实现每隔1秒输出1-2-3) 8.1 使用Promise实现每隔1秒输出1,2,3
...
### [#](#_8-2-使用promise实现红绿灯交替重复亮) 8.2 使用Promise实现红绿灯交替重复亮
...
### [#](#_8-3-实现mergepromise函数) 8.3 实现mergePromise函数
